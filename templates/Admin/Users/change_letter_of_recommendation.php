                ...
                <div class="card card-secondary">
                    ...
                    <div class="card-body collapse show" id="body4">
                        <div class="form-group">
                            <?php
                                echo $this->Form->control('verification.recomendacao', ['type' => 'file', 'label' => 'Carta de recomendação<small> (válido arquivos de imagem ou pdf)</small>', 'class' => 'form-control mb-2', 'escape' => false]);
                            ?>
                        </div>
                    </div>
